...
|字段|类型|主键，外键|可以为空|约束|说明|
|:-------:|:-------------:|:------:|:----:|:---:|:-----|    
|adminId|varchar(100)|主键|否||管理员ID|
|name|varchar(100)| |否||管理员姓名|  
|password|varchar(100)| |否||管理员密码，需加密|
|sex|bit(1)||否|1表示男，0表示女|管理员性别| 
|born|datetime||否|不能超过当前日期|管理员生日|  
|photo|varbinary(60000)||是||管理员照片|
|rule|bit(1)||否|1表示超级管理员，0表示图书管理员|管理员权限|   
